...
public class AbstractUserBean {
	...
	public AbstractUserBean(String username, String password, boolean rememberMe) throws WrongSyntaxException {
		this.setUsername(username);
		this.setPassword(password);
		this.setRememberMe(rememberMe);
	}
	
	public AbstractUserBean(String username, String password) throws WrongSyntaxException {
