...
import logic.model.proposal.state.ProposalStateMachine;
import logic.model.proposal.state.StateMachineImpl;
...
public class Proposal {
	...
	public Proposal (Reader src, Reader tgt, Book tgtBook, String proposalId) {
		...
		state = new StateMachineImpl(src, tgt, tgtBook, proposalId);
	}
