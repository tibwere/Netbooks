...
public abstract class AbstractState {
	...
	protected abstract void toAccept() throws PersistencyException, NoStateTransitionException;

	protected abstract void toReject() throws PersistencyException, NoStateTransitionException;
	
	protected abstract void acquire(Book book) throws NoStateTransitionException;
