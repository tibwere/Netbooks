            	...
            	<div class="col col-sm-8 col-md-8 col-lg-8 col-xl-8">
            		...
            		<form class="form-restyle border border-dark" action="SignupServlet" method="POST" id="signForm">	
            			<div class="form.group login-header">
            				...
            				<h3>SIGNIN WITH NETBOOKS (as a reader <i class="fas fa-book-reader"></i>)</h3>            				
            			</div> 
					  	<div class="form-row mb-1">
					    	<div class="col">
					      		<input type="text" class="form-control" placeholder="First name" id="nameTxt" name="name" required>
					    	</div>
					    	<div class="col">
					      		<input type="text" class="form-control" placeholder="Last name" id="surnameTxt" name="surname" required>
					    	</div>
					  	</div>
					  	<div class="form-row mb-1">
					    	<div class="col">
					  	...
					  	<div class="form-group mb-1">	
							<div class="form-check form-check-inline">
	  							...
	  							<label class="form-check-label" for="maleRadio">M</label>
							</div>
							<div class="form-check form-check-inline">
	  							<input class="form-check-input" type="radio" id="femaleRadio" value="female" name="gender" checked>
	  							<label class="form-check-label" for="femaleRadio">F</label>
							</div>
						</div>
						<div class="form-group mt-4	 mb-1">	
							<input type="hidden" name="typeOfSignup" value="reader">	
