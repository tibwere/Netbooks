							...
							case INITIAL_PROPOSAL: %>
								<div class="row justify-content-center self-align-center mb-md-3 mb-sm-3 mb-xs-3 mb-lg-3 ">
									<div class="col col-sm-8 col-md-8 col-lg-8 col-xl-8 notification mb-md-3 mt-md-3 mb-sm-3 mt-sm-3 mb-xs-3 mt-xs-3 shadow">
										...
										<div class="row justify-content-center self-align-center text-center p-3">
											<div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6">
												<form action="<%=WebUtilities.LOAD_OWNED_BOOKS_SERVLET_URL.substring(1)%>" method="post">
													...
													<button type="submit" class="btn ex-book-choose-btn font-weight-bold btn-sm" style="width:120px !important">
														Choose a book
													</button>
												</form>
											</div>
											<div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6">												
												<form action="<%=WebUtilities.MANAGE_PROPOSAL_SERVLET_URL.substring(1)%>" method="post">
													...
													<button type="submit" class="btn ex-book-reject-btn font-weight-bold btn-sm" style="width:120px !important">
														Reject
													</button>
												</form>
											</div>
							...
							case INTERMEDIATE_PROPOSAL: %>
								<div class="row justify-content-center  mb-md-3 mb-sm-3 mb-xs-3 mb-lg-3 ">
									<div class="col col-sm-8 col-md-8 col-lg-8 col-xl-8 notification mb-md-3 mt-md-3 shadow">
										...
										<div class="row justify-content-center align-self-center text-center p-3">
											<div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6">
												<form action="<%=WebUtilities.MANAGE_PROPOSAL_SERVLET_URL.substring(1)%>" method="post">
													...
													<button type="submit" class="btn ex-book-accept-btn font-weight-bold btn-sm" style="width:120px !important">
														Accept
													</button>
												</form>
											</div>
